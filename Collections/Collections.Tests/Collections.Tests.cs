...
namespace Collections.Tests
{
    public class Tests
    {
        ...
        [Test]
        public void Test_Index_SetIndex()
        {
            Collection<string> collection = new Collection<string>("Emma", "Ivan");

            var item0 = collection[0];
            var item1 = collection[1];


            Assert.That(item0, Is.EqualTo("Emma"));
            Assert.That(item1, Is.EqualTo("Ivan"));
